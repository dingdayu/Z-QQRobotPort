...
// //------------------- // 配置文件 //----------------------- // //
	...
	/***********API设置***********/	
	$Api_Url = 'http://3.dyapi.sinaapp.com/';
	$XY_Use = 'test';
	$XY_Key = 'test';

	/**********参数设置**********/
	$QQRobotIp = "";												//机器人IP，如果您无法使用QQRobotApi，请留空
	$Copyright = '';												//密钥,注意 QQRobotApi 密钥 ，默认不启动限制，请到Robot.php将注释去掉
	$Robotqq = array('2573797666');									//允许使用接口的机器人号吗,默认不启动限制，请到Robot.php将注释去掉
...
/**********菜单回复设置********/
	$help_ab = $help_ab = "[Face13.gif]             您好，我是小y!\r\n-------------你还可以使用如下帮助---------------\r\n@music      音乐下载\r\n@td         查询历史今天\r\n@xh         获得随机笑话\r\n@tq         查询城市天气\r\n@qq         查询qq是否在线\r\n@fy         翻译\r\n@时间       现在的时间\r\n@pn         查询手机归属地\r\n------------------------------------------------\r\n以上命令的使用方法均为 命令 + 空格 + 参数\r\n";
	//帮助菜单，用于快捷回复的帮助回复
